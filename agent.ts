	...
	tools: [
		{
			...
			name: 'end_call',
			description:
				'Hang up. Use this once you have said goodbye, or after leaving a voicemail.',
		},
	],
	...
	analysis: [
		{
			...
			name: 'sentiment',
			description:
				'How the person sounded. One of: "positive", "neutral", "negative".',
		},
		{
			type: 'string',
			name: 'summary',
		...
		},
		{
			...
			description: 'True only if the caller needs to be rescheduled.',
		},
	],
